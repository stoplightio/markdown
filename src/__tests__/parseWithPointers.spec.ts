...
describe('parseWithPointers', () => {
  ...
  describe('getJsonPathForPosition', () => {
    describe('basic fixture', () => {
      const { getJsonPathForPosition } = parseWithPointers(basic);
    ...
    describe('list fixture', () => {
      const { getJsonPathForPosition } = parseWithPointers(list);
  ...
  describe('getLocationForJsonPath', () => {
    describe('basic fixture', () => {
      const { getLocationForJsonPath } = parseWithPointers(basic);
    ...
    describe('list fixture', () => {
      const { getLocationForJsonPath } = parseWithPointers(list);
